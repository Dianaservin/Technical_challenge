...
def set_navigator_overrides(
    ...
    '''
    Overrides value returned by the javascript browser object.

    **EXPERIMENTAL**

    :param platform: The platform browser.platform should return.
    '''
    params: T_JSON_DICT = dict()
...
def set_data_saver_override(
    ...
    '''
    Override the value of browser.connection.saveData
...
def set_user_agent_override(
    ...
    :param platform: *(Optional)* The platform browser.platform should return.
    :param user_agent_metadata: **(EXPERIMENTAL)** *(Optional)* To be sent in Sec-CH-UA-* headers and returned in browser.userAgentData
    '''
    params: T_JSON_DICT = dict()
